<?php 
  ...
  $form = !empty($_POST["input_nome"]) &&  !empty($_POST["select_activo"]) && !empty($_POST["select_posicao"]) && !empty($_POST["text_conteudo"]);
  if($form){
    ...
    idu_sql("INSERT INTO empresas (nome, texto, activo, posicao) VALUES ('$nome', '$texto', '$activo', $posicao)");

    header("Location: empresa-add.php?saved=1");
    exit;
  }
        ...
        <div class="col-12 px-0">
          <form action="" method="post">
            ...
            <label for="nome">
              ...
              <br>
              <input type="text" value="" class="empresa" name="input_nome" id="nome" required>
            </label>
            ...
            <label for="posicao">
              ...
              <select name="select_posicao" id="posicao" class="empresa">
                <?php for($i = count($empresa) + 1; $i >= 1 ; $i--): ?>
            ...
            <label for="conteudo">
              ...
              <br>
              <textarea name="text_conteudo" id="conteudo" class="empresa"></textarea>
            </label>
            <hr class="my-3">
